...
// This class contaoins all the app text in Stroing format
class TTexts {
  ...
  static const String onBoardingSubTitle2 = "For Seamless Transactions, Choose Your Payment Path - Your Conveniece, Our Priority!";
